...
{
    public partial class PredictReview
    {
        public const string RetrainFilePath =  @"C:\Users\LENOVO\source\repos\MLPredict\ReviewPredict\IMDB Dataset.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"review",outputColumnName:@"review")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.1,LabelColumnName=@"sentiment",FeatureColumnName=@"Features"}),labelColumnName: @"sentiment"))      
